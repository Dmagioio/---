...
$mes = "<span style='font-size: 15px; line-height: 18px;'><b>Имя:</b> $name<br><b>Телефон:</b> $phone<br><b>Оффер:</b> $offer<br><b>Размер:</b> $size<br><b>IP:</b> $ip</span>";

$sub='ЗАЯВКА МИНИ РОЛИК';
$emails='info';
